  ...
  if(gameState===PLAY)
 {
  ...
  else
  {
   ...
   //setting the velocity to 0 if game state is end
 ...
 function createCash() 
 {
  ...
  var cash = createSprite(Math.round(random(0, width),width-40 ,10, 10));
  ...
  if (World.frameCount % 320 == 0)
 {
  ...
  var diamonds = createSprite(Math.round(random(0, width),width-60,10, 10));
  ...
  if (World.frameCount % 410 == 0) 
 {
  ...
  var jwellery = createSprite(Math.round(random(0, width),width-40, 10, 10));
  ...
  if (World.frameCount % 530 == 0) 
 {
  ...
  var sword = createSprite(Math.round(random(0, width),width-20 , 10, 10));
